...
// Module: MIL.C03_Logic.S01_Implication_and_the_Universal_Quantifier
...
LEAN_EXPORT lean_object* initialize_MIL_C03__Logic_S01__Implication__and__the__Universal__Quantifier(uint8_t builtin, lean_object* w) {
lean_object * res;
