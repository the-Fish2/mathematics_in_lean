...
// Module: MIL.C03_Logic.S06_Sequences_and_Convergence
...
LEAN_EXPORT lean_object* initialize_MIL_C03__Logic_S06__Sequences__and__Convergence(uint8_t builtin, lean_object* w) {
lean_object * res;
