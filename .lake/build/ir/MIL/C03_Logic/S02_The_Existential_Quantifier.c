...
// Module: MIL.C03_Logic.S02_The_Existential_Quantifier
...
LEAN_EXPORT lean_object* initialize_MIL_C03__Logic_S02__The__Existential__Quantifier(uint8_t builtin, lean_object* w) {
lean_object * res;
