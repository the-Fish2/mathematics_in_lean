...
// Module: MIL.C11_Integration_and_Measure_Theory.S03_Integration
...
LEAN_EXPORT lean_object* initialize_MIL_C11__Integration__and__Measure__Theory_S03__Integration(uint8_t builtin, lean_object* w) {
lean_object * res;
