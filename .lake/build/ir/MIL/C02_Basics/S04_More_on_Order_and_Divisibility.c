...
// Module: MIL.C02_Basics.S04_More_on_Order_and_Divisibility
...
LEAN_EXPORT lean_object* initialize_MIL_C02__Basics_S04__More__on__Order__and__Divisibility(uint8_t builtin, lean_object* w) {
lean_object * res;
